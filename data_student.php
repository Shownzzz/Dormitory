            ...
            <div class="row">
                ...
                <div style="background-color:white;" class="col-4 text-center">
                    <div class="col">
                        ...
                        <form method="post" action="datasql_student.php?Acc=<?= $Acc ?>&Ide=<?= $Ide ?>" class="card-body">
                            <div class="row mb-2 login">
                                <input class="col-sm-8" type="text" name="usrAcc" value=<?php echo $result['學生帳號']; ?> required="required">
                                <label for="inputaccount" class=" col-form-label text_label_color text-left">帳號</label>
                            </div>
                            <div class="row mb-2 login">
                                <input class="col-sm-8" type="password" name="usrPwd" value=<?php echo $result['密碼']; ?> required="required">
                                <label for="inputaccount" class=" col-form-label text_label_color text-left">密碼</label>
                            </div>
                            <div class="row mb-2 login">
                                <input class="col-sm-8" type="text" name="usrNum" value=<?php echo $result['學號']; ?> required="required">
                                <label for="inputaccount" class=" col-form-label text_label_color text-left">學號</label>
                            </div>
                            <div class="row mb-2 login">
                                <input class="col-sm-8" type="text" name="usrNam" value=<?php echo $result['姓名']; ?> required="required">
                                <label for="inputaccount" class=" col-form-label text_label_color text-left">姓名</label>
                            </div>
                            <div class="row mb-2 login">
                                <input class="col-sm-8" type="text" name="usrMai" value=<?php echo $result['Email']; ?> required="required">
                                <label for="inputaccount" class=" col-form-label text_label_color text-left">Email</label>
                            </div>
                            <div class="row mb-2 login">
                                <input class="col-sm-8" type="text" name="usrPho" value=<?php echo $result['連絡電話']; ?> required="required">
                                <label for="inputaccount" class=" col-form-label text_label_color text-left">電話</label>
                            </div>
                            <div class="row mb-2 login">
                                <input class="col-sm-8" type="text" name="usrYea" value=<?php echo $result['學年度']; ?> required="required">
                                <label for="inputaccount" class=" col-form-label text_label_color text-left">學年度</label>
                            </div>
                            <div class="row mb-2 login">
                                <input class="col-sm-8" type="text" name="usrLev" value=<?php echo $result['系級']; ?> required="required">
