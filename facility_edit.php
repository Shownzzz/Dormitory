...
$usrCheck = "SELECT * FROM 宿舍大樓基本資料,設備 WHERE 宿舍大樓名稱='$Building' AND 房間號碼='$roomID' AND 設備編號='$facilityID';";
$query_list = mysqli_query($link, $usrCheck);
$row_student = mysqli_fetch_assoc($query_list);
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 text-center" style="background-color:#ECF5FF; border-bottom:#5151A2 solid 2px;">
                <p></p>
                <h1 class="text-center" style="color:#5151A2; font-weight:bold;">編輯資訊</h1>
            </div>
            <div class="col-3"></div>
        </div>
        <div class="row">
            ...
            <div class="col-6 text-center" style="background-color:#ECF5FF;">
                <p></p>
                <form method="post" action="facilitysql_edit.php?Acc=<?= $Acc ?>&Ide=<?= $Ide ?>" style="color:#5151A2; font-weight:bold; font-size:20px;">
                    <div class="row mb-3">
                        <label for="inputPassword" class="col-sm-3 col-form-label">宿舍大樓</label>
                        <br>
                        <div class="col-sm-9" style="margin:auto;">
                            <input type="text" name='editfacilitybuilding' class="form-control" readonly value="<?php echo $row_student['宿舍大樓名稱']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <br>
                        <div class="col-sm-9" style="margin:auto;">
                            <input type="text" name='editfacilityroomID' class="form-control" readonly value="<?php echo $row_student['房間號碼']; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputPassword" class="col-sm-3 col-form-label">設備編號</label>
                        <br>
                        <div class="col-sm-9" style="margin:auto;">
                            <input type="text" name="editfacilityNo" class="form-control" readonly value="<?php echo $row_student['設備編號']; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <br>
                        <div class="col-sm-9" style="margin:auto;">
                            <input type="text" name="editfacillityName" class="form-control" value="<?php echo $row_student['設備名稱']; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <br>
                        <div class="col-sm-9" style="margin:auto;">
                            <input type="text" name="editfacilityCondition" class="form-control" value="<?php echo $row_student['設備狀況']; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <br>
                        <div class="col-sm-9" style="margin:auto;">
                            <input type="text" name="editfacilityQuantity" class="form-control" value="<?php echo $row_student['數量']; ?>">
                        </div>
                    </div>
                    <div class="text-end">
