...
$roomID = $_GET['roomID'];
$usrCheck = "SELECT * FROM 宿舍大樓基本資料 WHERE 宿舍大樓名稱='$Building' and 房間號碼=$roomID ;";
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-6 text-center" style="background-color:#ECF5FF;">
                <p></p>
                <form method="post" action="roomsql_edit.php?Acc=<?= $Acc ?>&Ide=<?= $Ide ?>" style="color:#5151A2; font-weight:bold; font-size:20px;">
                    <div class="row mb-3">
                        <label for="inputPassword" class="col-sm-3 col-form-label">宿舍大樓</label>
                        <br>
                        <div class="col-sm-9" style="margin:auto;">
                            <input type="text" name="editbuilding" class="form-control" readonly value="<?php echo isset($Building) ? $Building : ''; ?>">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <br>
                        <div class="col-sm-9" style="margin:auto;">
                            <input type="text" name="editroomID" class="form-control" readonly value="<?php echo isset($roomID) ? $roomID : ''; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <br>
                        <div class="col-sm-9" style="margin:auto;">
                            <input type="text" name="editcapacity" class="form-control" value="<?php echo $row_student['可容納人數']; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <br>
                        <div class="col-sm-9" style="margin:auto;">
                            <input type="text" name="editfee" class="form-control" value="<?php echo $row_student['房間住宿費用']; ?>">
                        </div>
                    </div>
                    <div class="text-end">
