...
$Acc = $_GET['Acc'];
$Ide = $_GET['Ide'];
$query = "SELECT * FROM `報修` INNER JOIN `學生` USING(`姓名`) WHERE 學生帳號='$Acc'";
...
<body>
    ...
    <div class="container">
        <h1 class="text-center" style="color:#5151A2; font-weight:bold;background-color:#ECF5FF;">報修進度查詢</h1>
        ...
        <a class="btn btn-outline-primary" href="apply_repair.php?Acc=<?= $Acc ?>&Ide=<?= $Ide ?>" role="button" style="float:right">報修申請</a>
    </div>
</body>
