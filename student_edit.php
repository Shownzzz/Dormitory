<?php
    ...
    $Ide=$_GET['Ide'];
    $usrID=$_GET['ID'];
    $sql="SELECT * FROM 學生 WHERE 學生帳號='$usrID'";
            ...
            <div class = "jumbotron jumbotron-fluid jumbotron-primary pic2 center">
                ...
                <div class="row">
                    <div class="col-2"></div>
                        ...
                        <form method = "post" action="studentsql_edit.php?Acc=<?=$Acc?>&Ide=<?=$Ide?>" class ="card-body">
                                        <div class="row mb-2 login">
                                            <input class = "col-sm-8" type="text" name="usrName" value=<?php echo $row['姓名']?> required="required">
                                            <label for="inputaccount" class=" col-form-label text_label_color text-left">姓名</label>
                                        </div>
                                        <div class="row mb-2 login">
                                            <input class = "col-sm-8" type="text" name="usrID" value=<?php echo $row['學號']?> required="required">
                                            <label for="inputaccount" class=" col-form-label text_label_color text-left">學號</label>
                                        </div>
                                        <div class="row mb-2 login">
                                            <input class = "col-sm-8" type="text" name="usrGru" value=<?php echo $row['系級']?> required="required">
                                            <label for="inputaccount" class=" col-form-label text_label_color text-left">系級</label>
                                        </div>
                                        <div class="row mb-2 login">
                                            <input class = "col-sm-8" type="text" name="usrYear" value=<?php echo $row['學年度']?> required="required">
                                            <label for="inputaccount" class=" col-form-label text_label_color text-left">學年</label>
                                        </div>
                                        <div class="row mb-2 login">
                                        ...
                                        <div class="row mb-2 login">
                                            <input class = "col-sm-8" type="text" name="usrAcc" readonly="readonly" value=<?php echo $row['學生帳號']?> readonly="readonly" required="required">
