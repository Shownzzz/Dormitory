        ...
        <div class = "container">
            <div class = "row">
                ...
                <div class = "col-6 text-center" style = "background-color:#ECF5FF; border-bottom:#5151A2 solid 2px;">
                    <p></p>
                    <h1 class="text-center" style = "color:#5151A2; font-weight:bold;">~新增公告~</h1>
                </div>
                <div class = "col-3"></div>
            </div>
            <div class="row">
                ...
                <div class="col-6 text-center" style = "background-color:#ECF5FF;">
                    <p></p>
                    <form method = "post" action="announcementsql_add.php?Acc=<?=$Acc?>&Ide=<?=$Ide?>" style = "color:#5151A2; font-weight:bold; font-size:20px;">
                        <!-- <div class="row mb-3">
                        ...
                        <div class="row">
                            ...
                            <a href="bulletinboard_list.php" class="btn-link offset-1"><button type="button" class="btn" style ="background-color:#5151A2; color:white; font-weight:bold; width:125px; height:40px;" >清除</button></a>
                        </div>
                    </form>
                    <p></p>
                </div>
