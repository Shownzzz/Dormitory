...
$Acc = $_GET['Acc'];
$Ide = $_GET['Ide'];
$sql = "SELECT * FROM 留言板 WHERE 留言編號='$usrID'";
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 text-center" style="background-color:#ECF5FF; border-bottom:#5151A2 solid 2px;">
                <p></p>
                <h1 class="text-center" style="color:#5151A2; font-weight:bold;">編輯留言</h1>
            </div>
            <div class="col-3"></div>
        </div>
        <div class="row">
            ...
            <div class="col-6 text-center" style="background-color:#ECF5FF;">
                <p></p>
                <form method="post" action="bulletinboardsql_edit.php?Acc=<?= $Acc ?>&Ide=<?= $Ide ?>&ID=<?= $usrID ?>" style="color:#5151A2; font-weight:bold; font-size:20px;">
                    <div class="row mb-3">
