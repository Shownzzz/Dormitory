            ...
            <div class = "jumbotron jumbotron-fluid jumbotron-primary pic2 center">
                ...
                <div class="row">
                    <div class="col-2"></div>
                        ...
                        <div class="col">
                            <h2></h2>
                        <h2 class="card text-center" style = "font-size:25px; font-weight:bold; color:#5151A2;">&emsp;舍監新增&emsp;</h2>
                        <form method = "post" action="dmangersql_register.php?Acc=<?=$Acc?>&Ide=<?=$Ide?>" class ="card-body">
