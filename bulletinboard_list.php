...
<body>
    ...
    <div class="container">
        <p></p>
        <h1 class="text-center" style="color:#5151A2; font-weight:bold;background-color:#ECF5FF;">留言板</h1>
        <a href="bulletinboard_add.php?Acc=<?= $Acc ?>&Ide=<?= $Ide ?>" class="btn-link"><button type="button" class="btn col-sm-1 offset-11" style="background-color:#5151A2; color:white; font-weight:bold;">新增留言</button></a>
        <br>
                ...
                ?>
                        <tr>
                            ...
                            <td style="vertical-align:middle;">
                                <a href="bulletinboard_edit.php?Acc=<?= $Acc ?>&Ide=<?= $Ide ?>&ID=<?= $phpID ?>" class="btn-link"><button type="button" class="btn btn-primary">編輯</button></a>
                                <a href="bulletinboardsql_delete.php?Acc=<?= $Acc ?>&Ide=<?= $Ide ?>&ID=<?= $phpID ?>" class="btn-link"><button type="button" class="btn btn-danger">刪除</button></a>
                            </td>
                        </tr>
                <?php
                    }
