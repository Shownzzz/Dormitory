    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 text-center" style="background-color:#ECF5FF; border-bottom:#5151A2 solid 2px;">
                <p></p>
                <h1 class="text-center" style="color:#5151A2; font-weight:bold;">新增違規紀錄</h1>
            </div>
            <div class="col-3"></div>
        </div>
        <div class="row">
            ...
            <div class="col-6 text-center" style="background-color:#ECF5FF;">
                <p></p>
                <form method="post" action="illegalsql_add.php?Acc=<?= $Acc ?>&Ide=<?= $Ide ?>" style="color:#5151A2; font-weight:bold; font-size:20px;">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label for="inputPassword" class="col-sm-2 col-form-label">學生帳號</label>
                        <br>
                        <div class="col-sm-10" style="margin:auto;">
                    ...
                    <div class="row mb-3">
                        <label for="inputPassword" class="col-sm-2 col-form-label">違規內容</label>
                        <div class="col-sm-10" style="margin:auto;">
