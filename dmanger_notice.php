...
$usrAcc = $_GET['Acc'];
$value = $_GET['Ide'];
$query = "SELECT * FROM 通知 WHERE 對象姓名 = (SELECT 舍監姓名 FROM 舍監 WHERE 舍監帳號 = '$usrAcc')";
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:middle;">
                                ...
                                <?php
                                    ...
                                    <a href="noticesql_edit.php?Acc=<?= $usrAcc ?>&Ide=<?= $value ?>&ID=<?= $phpID ?>" class="btn-link"><button type="button" class="btn btn-primary">已讀</button></a>
                                <?php
                                } ?>
