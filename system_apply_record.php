<?php 
    ...
    $Acc=$_GET['Acc'];
    $Ide=$_GET['Ide'];
    $query="SELECT * FROM 申請住宿的資料 LEFT join 學生 USING (學生帳號) WHERE 核可與否 != '' order by 資料編號 DESC";
...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style = "background-color:#0066CCAA;">
        ...
        <div class = "container">
            <h1 class="text-center" style = "color:#5151A2; font-weight:bold;background-color:#ECF5FF;">審核紀錄資料</h1>
