                ...
                <div class = "card" style = "background-color:#ECF5FF;">
                            ...
                            <div class="row">
                                ...
                                <div class = "col-lg-4">
                                    <p></p>
                                    <div class = "row justify-content-center">
                                        <a href="dmanger_list.php?Acc=<?=$row['管理員帳號']?>&Ide=<?=$value?>"><button class="btn float-right" style ="background-color:#5151A2; color:white; font-weight:bold; width:125px; height:40px;">舍監</button></a>
                                        &emsp;&emsp;&emsp;
                                        <a href="student_list.php?Acc=<?=$row['管理員帳號']?>&Ide=<?=$value?>"><button class="btn float-right" style ="background-color:#5151A2; color:white; font-weight:bold; width:125px; height:40px;">學生</button></a>
                                    </div>
                                    <br>
                                    <div class = "row row justify-content-center">
                                        <button class="btn float-right" style ="background-color:#9191A9; color:white; font-weight:bold; width:125px; height:40px;">系統管理員</button>
                                        &emsp;&emsp;&emsp;
                                        <a href="system_page.php?Acc=<?=$row['管理員帳號']?>&Ide=<?=$value?>"><button class="btn float-right" style ="background-color:#5151A2; color:white; font-weight:bold; width:125px; height:40px;">取消</button></a>
                                    </div>           
                                </div>
                            </div>
                            <br>
